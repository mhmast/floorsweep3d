...
{}
float4 FS( Floorsweep_UI_Rendering_Shaders_Cube_FragmentInput input)
{
...
fragment float4 FS(Floorsweep_UI_Rendering_Shaders_Cube_FragmentInput input [[ stage_in ]], texture2d<float> SurfaceTexture [[ texture(0) ]], sampler SurfaceSampler [[ sampler(0) ]])
{
